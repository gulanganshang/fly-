		...
		<div class="main">
			...
			<div class="nav-user">
				<c:if test="${ login_user == null }">
					...
					<span><a
						href="${ pageContext.request.contextPath }/page/loadlogin">登入</a><a
						href="${ pageContext.request.contextPath }/page/loadreg">注册</a></span>
					<p class="out-login">
						<a href=""
		...
		<div class="wrap">
			<div class="content">
				<div class="fly-tab fly-tab-index">
					...
					<a href="${ pageContext.request.contextPath }/page/add"
				...
				<c:if test="${ toplist != null }">
					...
					<li class="fly-list-li"><a href="user/home.html"
						...
						<h2 class="fly-tip">
							<a href="${ pageContext.request.contextPath }/article/detail/${ good.id }/${good.title}">${ good.title }</a> <c:if test="${ good.istop == 1 }"><span class="fly-tip-stick">置顶</span></c:if> <c:if test="${ good.isgood== 1 }"><span class="fly-tip-jing">精帖</span></c:if>
						</h2>
						<p>
					...
					<c:if test="${ artlist != null }">
						<c:forEach items="${ artlist }" var="common">
							<li class="fly-list-li"><a href="user/home.html"
								...
								<h2 class="fly-tip">
									<a
										href="${ pageContext.request.contextPath }/article/detail/${ common.id }">${common.title}</a>
								</h2>
								<p>
