  ...
  <script type="text/javascript">
  		$(function(){
  			$('#LAY-file').change(function(){
  				/* var formFile = new FormData($('#headform')[0]); */
  				var formFile = new FormData(document.getElementById('headform'));
  				...
  				$.ajax({
  	                ...
  	                success:function (data) {
  	                    // data是响应回来的头像路径
  	                    $('#headdiv').find('img').attr('src',data);
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        <div class="layui-form layui-form-pane layui-tab-item layui-show">
          ...
          <!-- 头像 -->
          <div id="headdiv" class="layui-form layui-form-pane layui-tab-item">
            <div class="layui-form-item">
              <div class="avatar-add">
                <p>建议尺寸168*168，支持jpg、png、gif，最大不能超过30KB</p>
                <div class="upload-img">
                 <form id="headform" method="post" enctype="multipart/form-data">
                  <input type="file" name="file" id="LAY-file" lay-title="上传头像" title="上传">
                  <!-- <input type="file" name="file" id="LAY-file1" lay-title="上传头像"> -->
                 </form>
                </div>
