	...
	$(function() {
		$('#L_email').blur(function(){
				if($('#L_email').val() != null && $('#L_email').val() != '' && $('#L_email').val().indexOf('@') !=-1 ){
					...
					$('#regmsg').html('该邮箱地址格式错误').css('color','red');
				}
			});
...
<body>
	...
	<div class="header">
		<div class="main">
			...
			<div class="nav">
				<a class="nav-this" href="${pageContext.request.contextPath}/jsp/index.jsp"> <i
			...
			<div class="nav-user">
				...
				<a class="avatar"
					href="${pageContext.request.contextPath}/user/index.html"> <img
					src="http://tp4.sinaimg.cn/1345566427/180/5730976522/0"> <cite>贤心</cite>
					<i>VIP2</i>
				</a>
				<div class="nav">
					<a href="${pageContext.request.contextPath}/user/set.html"><i
						class="iconfont icon-shezhi"></i>设置</a> <a href=""><i
						...
						<div class="layui-form layui-form-pane">
							<form id="regform" method="post" action="${pageContext.request.contextPath}/user/reg" >
								...
								<div class="layui-form-item">
									...
									<div id="passmsg" class="layui-form-mid layui-word-aux">6到16个字符</div>
								</div>
								<div class="layui-form-item">
