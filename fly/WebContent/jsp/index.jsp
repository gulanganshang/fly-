    ...
    <div class="content">
      ...
      <c:forEach items="${toplist}" var="top">
        <li class="fly-list-li">
          ...
          <h2 class="fly-tip">
            <a href="${pageContext.request.contextPath}/article/detail?artid=${top.id}">${top.title}</a>
      ...
      <li class="fly-list-li">
          ...
          <h2 class="fly-tip">
            <a href="${pageContext.request.contextPath}/article/detail?artid=${art.id}">${art.title}</a>
          </h2>
          <p>
